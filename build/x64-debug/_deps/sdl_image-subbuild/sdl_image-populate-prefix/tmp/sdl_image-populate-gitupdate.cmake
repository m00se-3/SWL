...
execute_process(
  COMMAND "C:/Program Files/Git/cmd/git.exe" --git-dir=.git show-ref "release-3.2.4"
  WORKING_DIRECTORY "C:/CppProjects/SWL/.cache/CPM/sdl_image/25f5"
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: 'C:/CppProjects/SWL/.cache/CPM/sdl_image/25f5'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: 'C:/CppProjects/SWL/.cache/CPM/sdl_image/25f5'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
